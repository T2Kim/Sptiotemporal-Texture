...
extern std::string intermediate_data_path;
extern std::string tex_mesh_path;
extern std::string atlas_path;
extern std::string atlas_path2;
extern std::string atlas_path3;
...
extern int BOUND_HOPS;
extern int COLSIM_HOPS;
extern int COLSIM_WINDOW_HALF;
extern int GEOSIM_HOPS_CURVATURE;
extern int GEOSIM_HOPS_STRETCH;

extern float COLSIM_SPATIAL_WEIGHT;
extern float COLSIM_TEMPORAL_WEIGHT;
...
extern bool RECORD_UNIT_SIMPLE;
