...
void main()
{
 ...
 // }
	...
	if(flags[0] == 0)
	  {
		...
		resultColor = vec4(ambientLighting + diffuseReflection + specularReflection, 1.0);
		...
		resultColor = texture2D(tex_n, tex_coord.xy);
	}
  ...
  /*if (resultColor.x < 0.01 && resultColor.y < 0.01 && resultColor.z < 0.01)
